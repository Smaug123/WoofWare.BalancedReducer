{
  description = "The balanced reducer from janestreet/core_kernel/balanced_reducer";
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      pname = "WoofWare.BalancedReducer";
    ...
    in {
      ...
      in {
        ...
        default = pkgs.buildDotnetModule {
          ...
          name = "WoofWare.BalancedReducer";
          src = ./.;
          projectFile = "./WoofWare.BalancedReducer/WoofWare.BalancedReducer.fsproj";
